...
public final class Enums {
    ...
    /**
     * Interpreta o código informado, encontrando o valor do Enum correspondente
     * entre o array de valores passados como parâmetro.
     * 
     * @param code Código a ser interpretado
     * @param values Valores possíveis do Enum para comparação. O código
     *        informado como parâmetro será comparado ao código parametrizado no
     *        enum
     * @return Valor do Enum correspondente ao código informado ou null, caso
     *         não seja encontrada correspondência
     *         
     ...
     *        informado como parâmetro será comparado ao código parametrizado no
     *        enum
     * @param defaultValue Valor padrão, caso não seja encontrada
     *        correspondência para o código informado
     * @return Valor do Enum correspondente ao código informado ou o valor
     *         padrão informado, caso não seja encontrada correspondência
     * 
     * @param <E> Tipo do Enum. Deve implementar a interface {@link CodedEnum}
     * @param <T> Tipo do código do Enum retornado na chamada {@link CodedEnum#getCode()}
     */
    public static <E extends CodedEnum<T>, T> E parse(final T code, final E[] values, final E defaultValue) {
