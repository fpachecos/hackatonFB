...
/**
 * <i>Checked Exception</i> lançada para indicar erros funcionais, no nível da aplicação.
 * <p>
 * Diferente das <i>unchecked exceptions</i>, que indicam bugs ou exceções no nível de sistema,
 * estas exceções precisam ser capturadas e tratadas em um bloco <code>catch</code>.
 * <p>
 * Esta classe deve ser usada com parcimônia. Se houver necessidade de criar novas exceções que
 * estendam de <code>BusinessException</code>, o assunto deve ser discutido com o time de
 * Arquitetura.
 * 
