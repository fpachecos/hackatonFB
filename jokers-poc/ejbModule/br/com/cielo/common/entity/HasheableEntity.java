...
/**
 * Entidade representante da regra que associa chave de pesquisa para valores.
 * 
...
public class HasheableEntity implements Hasheable {
  ...
  /**
   * </br>
   * Hash SHA-1 gerado a partir da concatenação dos campos que determinam o agrupamento das
   * transações em lançamentos financeiros.
   */
