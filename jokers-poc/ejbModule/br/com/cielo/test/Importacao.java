...
public class Importacao {
  ...
  public void importaFile() {
    ...
    try {
      ...
      logger.log(Level.SEVERE,
          "Map<Integer, List<String>> obtemDadosArquivo(String caminhoArquivo)", e);
    } finally {
      ...
      // System.out.println("Tempo de processamento em miliseconds - " + (System.currentTimeMillis()
      // - dataInicial));
    }
  ...
  private void writterError(List<ErroVO> lista) {
    ...
    try {
      ...
      logger.log(Level.SEVERE, "Erro na grava��o do arquivo: " + nomeArquivo, e);
