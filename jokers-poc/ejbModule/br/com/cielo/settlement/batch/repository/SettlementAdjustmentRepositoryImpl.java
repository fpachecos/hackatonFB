...
public class SettlementAdjustmentRepositoryImpl implements SettlementAdjustmentRepository {
   ...
   * (non-Javadoc)
   * 
   * @see br.com.cielo.settlement.batch.repository.SettlementAdjustmentRepository
   * #createAdjustment()
   */
  @Override
  public void createAdjustment(SettlementFinancialAdjustment item) {
    this.entityManager.createNativeQuery(SettlementAdjustmentRepository.INSERT)
        ...
        .setParameter(14, item.getAdjustment().getSettlementAdjstmentDate(), TemporalType.DATE)
        ...
        .setParameter(29, item.getAdjustment().getValueFlexibleTerm()).setParameter(30, 0)
