...
public interface SettlementAdjustmentRepository {
  ...
  public static String INSERT = "INSERT INTO tbsetr_adjustment ( " + " nu_financial_adjustment, "
      + " dt_batch, " + " nu_mod_customer, " + " cd_entry_type, " + " nu_batch, "
      + " cd_movement_type, " + " nu_nsu_refund, " + " nu_transaction_id_original, "
      + " nu_customer, " + " vl_adjustment_amount, " + " vl_net_amount, " + " vl_discount_amount, "
      + " dh_adjustment, " + " dt_settlement_adjustment, " + " in_settlement, " + " nu_request, "
      + " dh_request, " + " cd_request_type, " + " nu_load_file_id, " + " nu_terminal, "
      ...
      + " vl_discount_orig, " + " vl_flexible_term, " + " vl_issuer_rate_base, "
      + " vl_rate_incremental " + " ) VALUES ( " + " ?, " + " ?, " + " ?, " + " ?, " + " ?, "
      + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?," + " ?, " + " ?, " + " ?, " + " ?, "
      + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?, "
      + " ?, " + " ?, " + " ?, " + " ?, " + " ?, " + " ?" + " )";
