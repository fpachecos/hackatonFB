...
public class DomicileBankAdjust {
  ...
  /**
   * M�todo get do atributo cdDomicileBank
   *
  ...
  /**
   * M�todo set do atributo cdDomicileBank
   *
   * @param cdDomicileBank Valor para setar no atributo cdDomicileBank
   */
  ...
  /**
   * M�todo set do atributo products
   *
   * @param products Valor para setar no atributo products
   */
