...
/**
 *
 * Representa��o do produto do domicilio bancario para determinar o produto do ajuste
 * 
...
public class DomicilieProduct {
  ...
  /**
   * C�digo do produto do domicilio
   */
  private Product product;

  /**
   * Lista ordenada por data de liquida��o de forma crescente
   */
