 ...
 *
 * @author <a href="mailto:eyve2j@prestadorcbmp.com.br>Samuel Oliveira
 *         Santos</a>
 * @version $Id$
 *
 */
public class FutureEntry {
    ...
    /**
     * Método get do atributo product
     *
    ...
    /**
     * Método set do atributo product
     *
     * @param product
     *            Valor para setar no atributo product
     */
    ...
    /**
     * Método get do atributo netValue
     *
    ...
    /**
     * Método set do atributo netValue
     *
     * @param netValue
     *            Valor para setar no atributo netValue
     */
    ...
    public boolean equals(final Object another) {
        if (another instanceof FutureEntry && this.getProduct() != null && this.getProduct().getCode() != null
                        && this.getDtSettlement() != null) {
