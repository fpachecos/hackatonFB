...
/**
 * Classe SettlementFinancialMovementParamProvider. Prepara dados para Inserção na Tabela de
 * Settlement Movement, sendo FIDC ou não.
 *
...
public class SettlementFinancialMovementParamProvider {
  ...
  public void applyParameters(final SettlementFinancialMovement item, Query query) {
    ...
    query.setParameter(index++, item.getSettlementMovement().getTraceNumberFinancialMovement());
