...
/**
 * Implementação da inteface de serviço para Settlement.
 *
 * @author waldeir
...
public class SettlementServiceImpl implements SettlementService {
	...
	/*
     * (non-Javadoc)
     * @see br.com.cielo.settlement.batch.service.SettlementService#getContractedProduct (java.util.List, boolean)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see br.com.cielo.settlement.batch.service.SettlementService#adjustSettlementDate (java.util.Date,
     * java.lang.String)
     */
    @Override
