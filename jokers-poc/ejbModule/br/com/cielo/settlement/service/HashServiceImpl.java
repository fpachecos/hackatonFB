...
/**
 * Servi�o para gera��o de hash destinado ao n�mero do lan�amento financeiro. <br/>
 * Prov� m�todo para cria��o da chave de agrupamento e gera��o do hash em si. Servi�o para gera��o
 * de hash destinado ao n�mero do lan�amento financeiro. <br/>
 * Prov� m�todo para cria��o da chave de agrupamento e gera��o do hash em si.
 *
...
public class HashServiceImpl implements HashService {
   ...
   * (non-Javadoc)
   * 
   * @see br.com.cielo.settlement.batch.service.HashService#generateGroupingKey
  ...
  public String generateGroupingKey(final HashFields hashFieldsKey) {
    ...
    return sdf.format(hashFieldsKey.getSettlementDate()) + sdf.format(hashFieldsKey.getBatchDate())
        + StringUtils.leftPad(hashFieldsKey.getLoadFileId(), Integer.valueOf("30"), "0")
        + StringUtils.leftPad(hashFieldsKey.getCustomerNumber().toString(), Integer.valueOf("22"),
            "0")
        ...
        + StringUtils.leftPad(hashFieldsKey.getCustomerModNumber().toString(), Integer.valueOf("3"),
            "0")
        + StringUtils.leftPad(hashFieldsKey.getInstallmentSegment().toString(),
            Integer.valueOf("2"), "0")
        + StringUtils.leftPad(hashFieldsKey.getMovementType().toString(), Integer.valueOf("10"),
            "0")
        + StringUtils.leftPad(hashFieldsKey.getFundingCurrency().toString(), Integer.valueOf("6"),
            "0")
  ...
  public String generateGroupingKeyMovementCompany(final HashFieldsCompany hashFieldsKey) {
    ...
    return sdf.format(hashFieldsKey.getSettlementDate()) + sdf.format(hashFieldsKey.getBatchDate())
        + StringUtils.leftPad(hashFieldsKey.getLoadFileId(), Integer.valueOf("30"), "0")
        + StringUtils.leftPad(hashFieldsKey.getCompanyNumber().toString(), Integer.valueOf("22"),
            "0")
        + StringUtils.leftPad(hashFieldsKey.getProductCode().toString(), Integer.valueOf("4"), "0")
        + StringUtils.leftPad(hashFieldsKey.getCompanyModNumber().toString(), Integer.valueOf("3"),
            "0")
        + StringUtils.leftPad(hashFieldsKey.getInstallmentSegment().toString(),
            Integer.valueOf("2"), "0")
        + StringUtils.leftPad(hashFieldsKey.getMovementType().toString(), Integer.valueOf("10"),
   ...
   * (non-Javadoc)
   * 
   * @see br.com.cielo.settlement.batch.service.HashService#generateHashSHA1(java .lang.String)
   */
  @Override
  public String generateHashSHA1(final String characters) throws BusinessException {
    try {
      ...
      throw new BusinessException("Erro na gera��o do hash de agrupamento das transa��es", nsae);
    }
  }
}
