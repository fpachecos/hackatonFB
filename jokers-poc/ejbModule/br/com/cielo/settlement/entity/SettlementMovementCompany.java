...
public class SettlementMovementCompany extends HasheableEntity implements Cloneable, Serializable {
  ...
  /**
   * Campo String nuFinancialMovementCompany. NU_FINANCIAL_MOVEMENT_COMPANY VARCHAR(40) Numero que
   * identifica o movimento financeiro.
   *
   * Este Numero é um Hash, obtido a partir do agrupamento das seguintes colunas: (DT_SETTLEMENT,
   * CD_PRODUCT, DT_BATCH, NU_LOAD_FILE_ID, NU_CUSTOMER, NU_MOD_CUSTOMER, NU_INSTALLMENT_SEGMENT ,
   * CD_MOVEMENT_TYPE, CD_CURRENCY_CODE
   */
  ...
  /**
   * Campo Integer nuModCompany. NUMBER(2). Numero de identificação da empresa parceira
   */
  private Integer nuModCompany;

  /**
   * Campo Date dtBatch. Date & Time.Data do Lote em que foi capturada a Transação em Base II.
   */
  private Date dtBatch;

  /**
   * Campo Integer cdProduct.Number (4)."Código que identifica um Produto da Cielo. Nota: A análise
   * técnica detalhada está em andamento para determinar a lista completa e descrição / fonte da
   * lista."
   */
  ...
  /**
   * Long nuCompany.Number (10).Numero único que identifica o Parceiro Cielo no Cadastro da empresa.
   */

  private Long nuCompany;

  /**
   * Campo BigDecimal vlMovementNet.Number (17,2).Valor Líquido daquele Movimento
   */
  private BigDecimal vlMovementNet;

  /**
   * Campo BigDecimal vlMovementGross.Number (17,2). Valor Bruto daquele Movimento.
   */
  private BigDecimal vlMovementGross;

  /**
   * Campo Integer cdMovementStatus. Number (2). Codigo que identifica a situacao atual de um
   * movimento (registro) desta tabela.
   */
  private Integer cdMovementStatus;

  /**
   * Campo cdFundingCurrency. Variable characters (3).Moeda que será utilizada para liquidar a
   * transação junto ao Estabelecimento Comercial
   */
  private String cdFundingCurrency;

  /**
   * Campo Integer nuLoadFileId. Number (20).Número Identificador dado ao Arquivo de Base I
   * importado na tabela Captured Transaction.
   */

  private Long nuLoadFileId;

  /**
   * Campo nuFinancialMovement. Characters (40).Numero que identifica o movimento financeiro.
   */
  private String nuFinancialMovement;

  /**
   * Campo Integer nuModMovementCustomer. Number (2) .Número do cálculo do mod do Cliente utilizado
   * como chave e definir a subpartição.
   */
  private Integer nuModMovementCustomer;

  /**
   * Campo Integer nuCustomer. Number (10) .Número único que identifica um Cliente no cadastro de
   * cliente da emrpesa, que é reconhecido por todos os sistemas de informação que manipulam
  ...
  /**
   * Campo Date dhRecordCreation. Date & Time .Data e hora de Criação do Registro.
   */
  private Date dhRecordCreation;

  /**
   * Campo String nmLoginUserCreation.Variable characters (50).Nome do Login do Usuário que realizou
   * a Criação do Registro.
   */
  private String nmLoginUserCreation;

  /**
   * Campo Date dhRecordLastModified. Date & Time. Data e hora da Última Atualização do Registro.
   */
   ...
   *
   * @param nuFinancialMovementCompany Valor para setar no atributo nuFinancialMovementCompany
   */
   ...
   *
   * @param dtBatch Valor para setar no atributo dtBatch
   */
   ...
   *
   * @param cdMovementType Valor para setar no atributo cdMovementType
   */
   ...
   *
   * @param vlMovementNet Valor para setar no atributo vlMovementNet
   */
   ...
   *
   * @param vlMovementGross Valor para setar no atributo vlMovementGross
   */
   ...
   *
   * @param cdMovementStatus Valor para setar no atributo cdMovementStatus
   */
   ...
   *
   * @param cdFundingCurrency Valor para setar no atributo cdFundingCurrency
   */
   ...
   *
   * @param nuFinancialMovement Valor para setar no atributo nuFinancialMovement
   */
   ...
   *
   * @param nuModMovementCustomer Valor para setar no atributo nuModMovementCustomer
   */
   ...
   *
   * @param dhRecordCreation Valor para setar no atributo dhRecordCreation
   */
   ...
   *
   * @param nmLoginUserCreation Valor para setar no atributo nmLoginUserCreation
   */
   ...
   *
   * @param dhRecordLastModified Valor para setar no atributo dhRecordLastModified
   */
   ...
   *
   * @param nuLoadFileId Valor para setar no atributo nuLoadFileId
   */
   ...
   *
   * @param nmLoginUserLastModified Valor para setar no atributo nmLoginUserLastModified
   */
