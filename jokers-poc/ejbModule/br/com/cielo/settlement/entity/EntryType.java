...
public class EntryType implements Serializable{
     ...
     */
    public static final EntryType REFUND_ADJUSTMENT =
                    new EntryType(20005, "Ajuste de cancelamento");
    /**
    ...
    public static final EntryType GENERIC_ADJUSTMENT =
                    new EntryType(20009, "Ajuste Gen�rico");
   ...
   public static final EntryType SETTLEMENT_BIILING_ADJUSTMENT =
     ...
     */
    public static final EntryType CIELO_PLAN =
                    new EntryType(40001, "Plano Cielo");
