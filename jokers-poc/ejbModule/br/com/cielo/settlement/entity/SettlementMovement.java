...
public class SettlementMovement extends HasheableEntity implements Cloneable, Serializable {
  ...
  /**
   * Campo BigDecimal dailyDiscountValueAmt. VL_DAILY_DISCOUNT_AMOUNT NUMBER(15,2)
   */
  ...
  /**
   * Campo BigDecimal netTransactionValueAmt. VL_TRANSACTION_AMOUNT NUMBER(15, 2) - VL_MDR
   * NUMBER(15, 2)
   */
  ...
  /**
   * Atributo que identifica o ajuste, caso o movimento seja oriundo de um ajuste
   */
  ...
  /**
   * Retorna se precisa atualizar status ou n�o, utilizado no processo de copia da stage para
   * movement.
   *
   * @return Atualiza status?
   */
  public boolean updateStatusArvProcess() {
    return !MovementTypeEnum.LEAVING_RETENTION_BY_ARV_REASON.getCode()
        .equals(this.movementTypeCode);
  }
   ...
   *
   * @param netMovementValue Valor para setar no atributo netMovementValue
   */
   ...
   *
   * @param movementQtNumber Valor para setar no atributo movementQtNumber
   */
   ...
   *
   * @param grossMovementValue Valor para setar no atributo grossMovementValue
   */
   ...
   *
   * @param dailyDiscountValueAmt Valor para setar no atributo dailyDiscountValueAmt
   */
   ...
   *
   * @param dailyIcValueAmt Valor para setar no atributo dailyIcValueAmt
   */
   ...
   *
   * @param fundingCurrencyCode Valor para setar no atributo fundingCurrencyCode
   */
   ...
   *
   * @param settlementBaseDate Valor para setar no atributo settlementBaseDate
   */
   ...
   *
   * @param debitOrCredit Valor para setar no atributo debitOrCredit
   */
   ...
   *
   * @param traceSettlementDate Valor para setar no atributo traceSettlementDate
   */
   ...
   *
   * @param traceCustomerModNumber Valor para setar no atributo traceCustomerModNumber
   */
   ...
   *
   * @param currencyCode Valor para setar no atributo currencyCode
   */
   ...
   *
   * @param mdr Valor para setar no atributo mdr
   */
   ...
   *
   * @param interchangeCost Valor para setar no atributo interchangeCost
   */
   ...
   *
   * @param netTransactionValueAmt Valor para setar no atributo netTransactionValueAmt
   */
   ...
   *
   * @param movementStatusCode Valor para setar no atributo movementStatusCode
   */
   ...
   *
   * @param batchOffsetEntry Valor para setar no atributo batchOffsetEntry
   */
   ...
   *
   * @param originalSettlementDate Valor para setar no atributo originalSettlementDate
   */
   ...
   *
   * @param numberFinancialMovement String
   */
   ...
   *
   * @param traceNumberFinancialMovement String
   */
   ...
   *
   * @param listTransactionMovementKey List<TransactionMovementKey>
   */

  // public void setListTransactionMovementKey(final List<TransactionMovementKey>
  // listTransactionMovementKey) {
   ...
   *
   * @param movementRelPayment Valor para setar no atributo movementRelPayment
   */
   ...
   *
   * @param productSettlementType Valor para setar no atributo productSettlementType
   */
   ...
   *
   * @param installmentSequence Valor para setar no atributo installmentSequence
   */
   ...
   *
   * @param totalInstallement Valor para setar no atributo totalInstallement
   */
   ...
   *
   * @param paymentBlockedReason Valor para setar no atributo paymentBlockedReason
   */
   ...
   *
   * @param settlementTypeIndicator indicador do tipo de cancelamento
   */
   ...
   *
   * @param merchantBank Valor para setar no atributo merchantBank
   */
   ...
   *
   * @param numberFinancialMovementOrig Valor para setar no atributo numberFinancialMovementOrig
   */
   ...
   * @throws CloneNotSupportedException lan�ada quando a clonagem n�o � poss�vel
   */
  @JsonIgnore
   ...
   *
   * @param valueAmountDiscount Valor para setar no atributo valueAmountDiscount
   */
   ...
   * M�todo set do atributo cardAssociation
   *
   * @param cardAssociation Valor para setar no atributo cardAssociation
   */
