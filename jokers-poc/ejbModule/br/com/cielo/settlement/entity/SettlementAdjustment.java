...
public class SettlementAdjustment implements Serializable {
  ...
  /**
   * M�todo get do atributo batchNumber
   *
  ...
  public String toString() {
    return "SettlementAdjustment ["
        ...
        + (this.origialTransactionId != null
            ? "origialTransactionId=" + this.origialTransactionId + ", " : "")
        + (this.customerNumber != null ? "customerNumber=" + this.customerNumber + ", " : "")
        + (this.adjustmentAmountValue != null
            ? "adjustmentAmountValue=" + this.adjustmentAmountValue + ", " : "")
        ...
        + (this.settlementAdjstmentDate != null
            ? "settlementAdjstmentDate=" + this.settlementAdjstmentDate + ", " : "")
        ...
        + (this.adjustmentIcValue != null ? "adjustementIcValue=" + this.adjustmentIcValue + ", "
            : "")
        + (this.installmentSequenceOrig != null
            ? "installmentSequenceOrig=" + this.installmentSequenceOrig + ", " : "")
        ...
        + (this.financialAdjustmentNumber != null
            ? "financialAdjustmentNumber=" + this.financialAdjustmentNumber + ", " : "")
        ...
        + (this.valueFlexibleTerm != null ? "valueFlexibleTerm=" + this.valueFlexibleTerm + ", "
            : "")
        + (this.vlGrossAvailableAmountTrans != null
            ? "vlGrossAvailableAmountTrans=" + this.vlGrossAvailableAmountTrans + ", " : "")
        + (this.dtBatchTrans != null ? "dtBatchTrans=" + this.dtBatchTrans : "") + "]";
  }

  /**
   * M�todo set do atributo batchNumber
   *
   * @param batchNumber Valor para setar no atributo batchNumber
   */
   ...
   *
   * @param movementTypeCode Valor para setar no atributo movementTypeCode
   */
  ...
  /**
   * M�todo get do atributo requestNumber
   *
  ...
  /**
   * M�todo set do atributo requestNumber
   *
   * @param requestNumber Valor para setar no atributo requestNumber
   */
  ...
  /**
   * M�todo get do atributo requestDate
   *
  ...
  /**
   * M�todo set do atributo requestDate
   *
   * @param requestDate Valor para setar no atributo requestDate
   */
  ...
  /**
   * M�todo get do atributo refundNsu
   *
  ...
  /**
   * M�todo set do atributo refundNsu
   *
   * @param refundNsu Valor para setar no atributo refundNsu
   */
  ...
  /**
   * M�todo get do atributo origialTransactionId
   *
  ...
  /**
   * M�todo set do atributo origialTransactionId
   *
   * @param origialTransactionId Valor para setar no atributo origialTransactionId
   */
  ...
  /**
   * M�todo get do atributo adjustmentAmountValue
   *
  ...
  /**
   * M�todo set do atributo adjustmentAmountValue
   *
   * @param adjustmentAmountValue Valor para setar no atributo adjustmentAmountValue
   */
  ...
  /**
   * M�todo get do atributo netAmountValue
   *
  ...
  /**
   * M�todo set do atributo netAmountValue
   *
   * @param netAmountValue Valor para setar no atributo netAmountValue
   */
  ...
  /**
   * M�todo get do atributo discountAmountValue
   *
  ...
  /**
   * M�todo set do atributo discountAmountValue
   *
   * @param discountAmountValue Valor para setar no atributo discountAmountValue
   */
  ...
  /**
   * M�todo get do atributo adjustmentDate
   *
  ...
  /**
   * M�todo set do atributo adjustmentDate
   *
   * @param adjustmentDate Valor para setar no atributo adjustmentDate
   */
  ...
  /**
   * M�todo get do atributo settlementAdjstmentDate
   *
  ...
  /**
   * M�todo set do atributo settlementAdjstmentDate
   *
   * @param settlementAdjstmentDate Valor para setar no atributo settlementAdjstmentDate
   */
  ...
  /**
   * M�todo get do atributo inSettlement
   *
  ...
  /**
   * M�todo set do atributo inSettlement
   *
   * @param inSettlement Valor para setar no atributo inSettlement
   */
   ...
   *
   * @param loadFileIdNumber Valor para setar no atributo loadFileIdNumber
   */
  ...
  /**
   * M�todo get do atributo terminalNumber
   *
  ...
  /**
   * M�todo set do atributo terminalNumber
   *
   * @param terminalNumber Valor para setar no atributo terminalNumber
   */
   ...
   *
   * @param acquirerCode Valor para setar no atributo acquirerCode
   */
  ...
  /**
   * M�todo get do atributo technologyType
   *
  ...
  /**
   * M�todo set do atributo technologyType
   *
   * @param technologyType Valor para setar no atributo technologyType
   */
  ...
  /**
   * M�todo get do atributo adjustementIcValue
   *
  ...
  /**
   * M�todo set do atributo adjustementIcValue
   *
   * @param adjustmentIcValue Valor para setar no atributo adjustementIcValue
   */
  ...
  /**
   * M�todo get do atributo installmentSequenceOrig
   *
  ...
  /**
   * M�todo set do atributo installmentSequenceOrig
   *
   * @param installmentSequenceOrig Valor para setar no atributo installmentSequenceOrig
   */
  ...
  /**
   * M�todo get do atributo movement
   *
  ...
  /**
   * M�todo set do atributo movement
   *
   * @param movement Valor para setar no atributo movement
   */
  ...
  /**
   * M�todo get do atributo requestType
   *
  ...
  /**
   * M�todo set do atributo requestType
   *
   * @param requestType Valor para setar no atributo requestType
   */
  ...
  /**
   * M�todo get do atributo adjustmentReason
   *
  ...
  /**
   * M�todo set do atributo adjustmentReason
   *
   * @param adjustmentReason Valor para setar no atributo adjustmentReason
   */
  ...
  /**
   * M�todo get do atributo financialAdjustmentNumber
   *
  ...
  /**
   * M�todo set do atributo financialAdjustmentNumber
   *
   * @param financialAdjustmentNumber Valor para setar no atributo financialAdjustmentNumber
   */
   ...
   *
   * @return n�mero do lan�amento financeiro.
   */
   ...
   *
   * @param financialMovement n�mero do lan�amento financeiro.
   */
  ...
  // * n�mero do lan�amento financeiro.
  // */
  ...
  /**
   * M�todo get do atributo valueOrigDiscount
   *
  ...
  /**
   * M�todo set do atributo valueOrigDiscount
   *
   * @param valueOrigDiscount Valor para setar no atributo valueOrigDiscount
   */
   ...
   *
   * @param valueFlexibleTerm Valor para setar no atributo valueFlexibleTerm
   */
  ...
  /**
   * M�todo get do atributo vlGrossAvailableAmountTrans
   *
  ...
  /**
   * M�todo set do atributo vlGrossAvailableAmountTrans
   *
   * @param vlGrossAvailableAmountTrans Valor para setar no atributo vlGrossAvailableAmountTrans
   */
  ...
  /**
   * M�todo get do atributo dtBatchTrans
   *
  ...
  /**
   * M�todo set do atributo dtBatchTrans
   *
   * @param dtBatchTrans Valor para setar no atributo dtBatchTrans
   */
